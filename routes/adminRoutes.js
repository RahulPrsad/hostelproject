...
router.post('/students/:id/present', adminController.markStudentPresent);
...
router.get('/api/student-equipment', adminController.activeEquipmentByStudent);
...
router.post('/equipment/:id/return/qr', adminController.returnEquipmentByQR);
